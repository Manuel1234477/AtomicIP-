...
pub enum DataKey {
    ...
    IpAuditTrail(u64),      // Issue #436: append-only audit trail for an IP record
    ShardIps(u32),          // Issue #437: maps shard_id -> Vec<u64> of IP IDs in that shard
    CompressedCommitment(u64), // Issue #438: stores 16-byte compressed commitment hash
}
