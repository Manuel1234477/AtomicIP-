...
pub enum DataKey {
    ...
    // Issue #436: immutable audit trail per IP
    IpAuditTrail(u64),
    // Issue #437: shard -> Vec<u64> of IP IDs
    ShardIps(u32),
    // Issue #438: compressed (16-byte) commitment per IP
    ...
    // Issue #447: staking
    IpStake(u64),
    // Issue #448: reputation
    OwnerReputation(Address),
    // Issue #449: arbitration
    ArbitratorPool,
    ArbitrationCase(u64),
    NextArbitrationId,
}
